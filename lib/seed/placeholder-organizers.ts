...
const VENUES = {
  ...
  axisResidences: {
    name: "Axis Residences Tower B",
    address: "Axis Residences Tower B, Mandaluyong, Metro Manila",
    lat: 14.5765,
    lng: 121.0532,
  },
  cherryTurf: {
  ...
  bridgetownPasig: {
    name: "Bridgetown",
    address: "Bridgetowne, Pasig, Metro Manila",
    lat: 14.5755,
    lng: 121.0912,
  },
...
export const PLACEHOLDER_ORGANIZER_SEEDS: OrganizerSeed[] = [
  ...
  },
  {
    ...
    bio: "Tuesday, Thursday, and Friday night football at Bridgetown, Pasig. 9–11 PM, ₱350/player.",
    verified: true,
    preferred_areas: "Bridgetowne, Pasig",
    game_preference: "football",
  ...
  },
  {
    ...
    bio: "Futsal at Axis Residences Tower B (Wed & Sat, ₱300) and Cherry Turf (Sun, ₱400) in Mandaluyong.",
    verified: true,
