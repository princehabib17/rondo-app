    ...
    >
      ...
      >
        ...
        <Button onPress={handleContinue} loading={loading} size="lg" style={styles.continueBtn}>
          {mode === 'email' ? 'Create account' : 'Send Code'}
        </Button>
...
const styles = StyleSheet.create({
  ...
  modeBtnActive: { backgroundColor: colors.bg },
  modeText: { ...font.bodyMed, color: colors.textMuted },
  modeTextActive: { color: colors.text },

  phoneGroup: { marginBottom: spacing.md, gap: spacing.xs },
  emailGroup: { marginBottom: spacing.md, gap: spacing.sm },
  ...
  infoText: { ...font.caption, color: colors.textSecondary },
