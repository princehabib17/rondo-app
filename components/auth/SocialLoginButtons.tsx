    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-4 justify-center">
        <button
          ...
          className="w-11 h-11 rounded-[var(--r-sm)] bg-[var(--bg-page)] border border-[var(--stroke)] flex items-center justify-center hover:border-[var(--gold)] transition disabled:opacity-50"
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5 fill-[var(--ink-hi)]" aria-hidden>
