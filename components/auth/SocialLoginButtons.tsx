...
export function SocialLoginButtons() {
  ...
  return (
    <div className="space-y-3">
      <p className="text-center text-[var(--ink-mid)] text-xs uppercase tracking-wider">Or login using</p>
      <div className="flex gap-4 justify-center">
        <button
          ...
          className="w-11 h-11 rounded-[var(--r-sm)] bg-[var(--bg-surface)] border border-[var(--stroke)] flex items-center justify-center hover:border-[var(--gold)] transition disabled:opacity-50"
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5 fill-[var(--ink-hi)]" aria-hidden>
        ...
        {providers.some((provider) => provider.id === "facebook") && (
          <button
            ...
            className="w-11 h-11 rounded-[var(--r-sm)] bg-[#1877F2] flex items-center justify-center hover:brightness-110 transition disabled:opacity-50"
          >
