    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-4 justify-center">
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full border border-[var(--stroke)] bg-[var(--bg-page)] transition hover:border-[var(--ink-mid)] disabled:opacity-50"
        >
