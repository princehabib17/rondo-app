...
export default function FeedPage() {
  ...
  return (
    <div className={`flex flex-col ${view === "map" ? "h-[100dvh]" : "min-h-[100dvh]"}`}>
      {/* Header */}
      <header className="sticky top-0 bg-background/90 backdrop-blur-md border-b border-border z-40 px-4 py-3 shrink-0">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex items-center bg-secondary rounded-lg p-0.5 border border-border">
              <button
                ...
                className={`min-w-[36px] min-h-[36px] flex items-center justify-center rounded-md transition-all cursor-pointer ${
                  view === "list"
            ...
            <button
              className="min-w-[44px] min-h-[44px] flex items-center justify-center text-muted-foreground hover:text-white transition-colors cursor-pointer"
      ...
      <div className="border-b border-border bg-background px-4 py-3 space-y-2 shrink-0">
